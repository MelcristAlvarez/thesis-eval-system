...
function StarRating({ value, onChange }) {
  ...
  const labels = ["", "Poor", "Below Average", "Satisfied", "Good", "Excellent"];
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "3px", flexWrap: "wrap" }}>
      {[1, 2, 3, 4, 5].map(n => (
        <button key={n} type="button" onClick={() => onChange(n)}
          ...
          style={{
            background: "none", border: "none", padding: "2px", fontSize: "24px", lineHeight: 1,
    ...
    <div>
      ...
      {evaluationCriteria.map((c, i) => (
        <div key={c.id} style={{
          ...
          <p style={{
            fontSize: "10px", fontWeight: 700, color: "var(--amber)", letterSpacing: "0.06em",
            ...
            return (
              <Card key={f.id} style={{
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{
                    fontSize: "12px", color: "var(--text-second)",
                    whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis"
                  }}>
                    {f.code} · {f.subject}
                  </p>
