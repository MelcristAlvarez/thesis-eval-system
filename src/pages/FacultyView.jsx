...
function StatusBadge({ status }) {
  ...
  return <span style={{
    ...
    borderRadius: "99px", padding: "4px 14px", display: "inline-block"
  }}>{s.label}</span>;
}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "24px", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, minWidth: "200px" }}>
            ...
            <h2 style={{
              ...
              color: "var(--text-primary)", marginBottom: "8px", lineHeight: 1
            }}>{faculty.name}</h2>
      ...
      <div className="grid-2" style={{ gap: "16px", marginBottom: "18px" }}>
        ...
        <Card>
          ...
          {faculty.chairEvaluated && faculty.chairScoreBreakdown ? (
            <>
              <p style={{
                fontSize: "10px", fontWeight: 700, color: "var(--gold-darker)",
      ...
      <Card style={{ padding: "18px 22px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap" }}>
          <div style={{ flex: 1, minWidth: "200px" }}>
            ...
            <div style={{
              height: "10px", background: "var(--bg-elevated)", borderRadius: "99px",
              overflow: "hidden", position: "relative"
            }}>
              <div style={{
                position: "absolute", left: `${(4.25 / 5) * 100}%`, top: 0,
                width: "2px", height: "100%", background: "var(--text-muted)", zIndex: 2
              }} />
              <div style={{
                width: `${(faculty.compositeScore / 5) * 100}%`, height: "100%",
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <p style={{
                  fontFamily: "var(--font-display)", fontSize: "22px", fontWeight: 600,
                  color: "var(--gold-darker)", lineHeight: 1
                }}>{s.value}</p>
                <p style={{
...
function MyFeedback({ faculty }) {
  ...
  return (
    <div className="anim-fade-in">
      <div style={{
        padding: "14px 18px", background: "rgba(200,148,10,0.08)",
      ...
      <div className="grid-2" style={{ gap: "14px", marginBottom: "14px" }}>
        <Card style={{ borderLeft: "3px solid #1E6E3E" }}>
          <p style={{
            ...
            textTransform: "uppercase", color: "#1E6E3E", marginBottom: "12px"
          }}>✦ Strengths</p>
          {fb.strengths.map((s, i) => (
            <p key={i} style={{
              fontSize: "13px", color: "var(--text-second)", lineHeight: 1.7,
              marginBottom: i < fb.strengths.length - 1 ? "10px" : 0
            }}>{s}</p>
          ))}
        </Card>
        <Card style={{ borderLeft: "3px solid #C8940A" }}>
          <p style={{
            fontSize: "10px", fontWeight: 700, letterSpacing: "0.08em",
            textTransform: "uppercase", color: "#C8940A", marginBottom: "12px"
          }}>◈ Points for Improvement</p>
          {fb.improvements.map((s, i) => (
            <p key={i} style={{
              fontSize: "13px", color: "var(--text-second)", lineHeight: 1.7,
              marginBottom: i < fb.improvements.length - 1 ? "10px" : 0
            }}>{s}</p>
          ))}
        </Card>
      </div>
      ...
      <Card style={{ marginBottom: "14px" }}>
        ...
        {fb.citations.map((c, i) => (
          <p key={i} style={{
            ...
            marginBottom: i < fb.citations.length - 1 ? "10px" : 0
          }}>{c}</p>
        ))}
      </Card>
      ...
      <Card style={{ background: "rgba(200,148,10,0.06)", border: "1px solid rgba(200,148,10,0.22)" }}>
        <p style={{
          fontSize: "10px", fontWeight: 700, letterSpacing: "0.08em",
          textTransform: "uppercase", color: "#A07800", marginBottom: "10px"
        }}>🎯 Recommendation</p>
