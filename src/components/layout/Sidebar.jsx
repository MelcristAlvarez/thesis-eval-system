...
const roleLabel = { student: "Student", chairperson: "Program Chair", hr: "HR Officer", dean: "Dean" };
const roleDot = { student: "#2E9E5E", chairperson: "#F2B800", hr: "#F2B800", dean: "#F2B800" };
  ...
  return (
    <>
      ...
      <aside className={`sidebar${isOpen ? " open" : ""}`}>
        ...
        <div style={{
          background: "#F2B800", padding: "14px 18px",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
              ...
              <div style={{ minWidth: 0 }}>
                <p style={{
                  fontSize: "13px", fontWeight: 600, color: "#FFFFFF", lineHeight: 1.2,
        ...
        <nav style={{ padding: "12px 12px", flex: 1 }}>
          <p style={{
            fontSize: "9.5px", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase",
            color: "rgba(255,255,255,0.28)", padding: "0 8px", marginBottom: "6px"
          }}>Navigation</p>
          {items.map(item => {
