...
const roleLabel = { student:"Student", chairperson:"Program Chair", hr:"HR Officer", dean:"Dean", faculty:"Faculty" };
const roleDot   = { student:"#2E9E5E", chairperson:"#F2B800", hr:"#F2B800", dean:"#F2B800", faculty:"#F2B800" };
      ...
      <aside className={`sidebar${isOpen?" open":""}`}>
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <img src={logo} alt="UST-Legazpi Seal" style={{ width: "100%", height: "100%", objectFit: "contain" }} />
          </div>
